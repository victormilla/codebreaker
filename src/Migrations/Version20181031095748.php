 ...
 */
final class Version20181031095748 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attempted_guess (id INT AUTO_INCREMENT NOT NULL, codebreaker_id INT DEFAULT NULL, exact INT NOT NULL, partial INT NOT NULL, guess VARCHAR(255) NOT NULL COMMENT \'(DC2Type:codebreaker_code)\', INDEX IDX_3BF4E446D7091452 (codebreaker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE attempted_guess ADD CONSTRAINT FK_3BF4E446D7091452 FOREIGN KEY (codebreaker_id) REFERENCES codebreaker (id)');
    }
